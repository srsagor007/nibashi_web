...
<head>
    ...
    <title>{{ settings('site_info', 'site_title') }} | Login</title>
            ...
            <div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
                ...
                <div class="d-flex flex-center flex-lg-start flex-column">
                    ...
                    <a href="{{ route('dashboard') }}" class="mb-7">
                        ...
                        <img alt="Logo" src="{{ asset('storage/' . settings('site_info', 'site_logo'))  }}" style="width: 300px;" />
                        @else
                        <h2>Appinion</h2>
                        @endif
                    </a>
                ...
                <div class="bg-body d-flex flex-column align-items-stretch flex-center rounded-4 w-md-600px p-20">
                    ...
                    <div class="">
                        <div class="text-center">
                            ...
                            <a href="#">Golden Harvest</a> All Rights Reserved. <br>
