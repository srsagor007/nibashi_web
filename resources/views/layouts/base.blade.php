...
<head>
    ...
    <title>@yield('title', 'Home') | {{ settings('site_info', 'site_title') }}</title>

    <meta name="description" content="Golden Harvest MGMT">
    ...
    <!--end::Fonts-->
    <!--start::FlatPicker Month CSS-->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/flatpickr/dist/plugins/monthSelect/style.css" />
    <!--end::FlatPicker Month CSS-->
    ...
    <!--begin::Global Flat Picker month select-->
    <script src="https://cdn.jsdelivr.net/npm/flatpickr/dist/plugins/monthSelect/index.js"></script>
    <!--end::Global Flat Picker month select-->
