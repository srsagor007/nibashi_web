...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="mb-2">
                ...
                <button type="button" class="btn btn-sm fw-bold btn-success" id="export_button">Export</button>
                ...
                <div class="card-body">
                    @php
                        $columns = [
                            ...
                            // ['data' => '_photo', 'name' => '_photo', 'searchable' => false ,'th' => 'User Image'], 

                            ['data' => 'name', 'name' => 'name', 'orderable'=> false],
                            ['data' => 'userid', 'name' => 'userid', 'orderable'=> false, 'th' => 'Renata ID'],
                            ['data' => 'user_code', 'name' => 'user_code', 'orderable'=> false, 'th' => 'User Code'],
                            ['data' => 'tbl_business_business_code', 'name' => 'tbl_business_business_code', 'searchable'=> false, 'th'=> 'BCode'],
                            ...
                            ['data' => '_rsm_region', 'name' => 'rsm_region', 'searchable'=> false, 'orderable'=> false, 'th' => 'RSM Region'],
    ...
    <x-modal id="filter_modal" title="Filter" size="md">
        <form id="filterForm">
            ...
            <div class="modal-body">
                <x-form-group>
                    <x-form-label for="filter_role_id">User type</x-form-label>
...
@push('scripts')
    ...
    $('#export_button').on('click', function () {
        var filter_role_id = $('#filter_role_id').val();
        var actionUrl = '{{ route('user.export') }}' + `?role_id=${filter_role_id}`;

        // Optional: submit form or redirect
