                    ...
                    <form action="{{ route('users.store') }}" method="POST" id="user_form" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12 mb-4 text-center">
                            <div class="image-input image-input-circle mb-3" data-kt-image-input="true">
                                <div class="image-input-wrapper w-125px h-125px border border-2 border-secondary" style="background-image: url('{!! asset('img/blank-avatar-profile.webp') !!}')"></div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <x-form-group>
                                    ...
                                    <input type="text" name="userid" id="userid" class="form-control" placeholder="RFXXXX" value="{{ old('userid') }}" required />
                            ...
                            <div class="col-md-6">
                                <x-form-group>
                                    ...
                                    <input type="number" name="phone" minlength="11" maxlength="11"  id="phone" class="form-control" placeholder="01XXXXXXXXX" value="{{ old('phone') }}"/>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <x-form-group>
                                    ...
                                    <select name="tbl_business_business_code" id="tbl_business_business_code" class="form-select" required>
                                        <option value="">-Select Business-</option>
                                        @foreach ($business_units as $business)
                                            <option value="{{ $business->business_code }}"
                                                    {{ selected($business->business_code, old('tbl_business_business_code')) }}>
                            ...
                            <div class="row">
                                    ...
                                    <x-form-group>
                                        ...
                                        <select name="tbl_depot_id" id="tbl_depot_id" class="form-select">
                                            ...
                                            @foreach ($depots as $depot)
                                                <option value="{{ $depot->id }}" {{ selected($depot->id, old('tbl_depot_id')) }}>
                                ...
                                <div class="col-md-6" id="user_code_area">
                                    <x-form-group>
                                        ...
                                        <input type="text" name="user_code" id="user_code" class="form-control" value="{{ old('user_code') }}" />
                                        <small class="text-info">N.B: code must be 2 digits for DSM & RSM.</small>
                            ...
                            <div class="row d-none" id="dsm_area">
                                    ...
                                    <x-form-group>
                                        ...
                                        <select name="tbl_pso_user_type_id" id="tbl_pso_user_type_id" class="form-select">
                                            ...
                                            @foreach ($pso_user_types as $pso_user_type)
                                                <option value="{{ $pso_user_type->id }}" {{ selected($pso_user_type->id, old('tbl_pso_user_type_id')) }}>
                                ...
                                <div class="col-md-6">
                                    <x-form-group>
                                        ...
                                        <input type="text" name="parent_rsm_code" id="parent_rsm_code" class="form-control" placeholder="Parent RSM Code" value="{{ old('parent_rsm_code') }}" />
                            ...
                            <div class="row d-none" id="rsm_area">
                                    ...
                                    <x-form-group>
                                        ...
                                        <select name="rsm_region_id" id="rsm_region_id" class="form-control">
                                            ...
                                            @foreach ($regions as $region)
                                                <option value="{{ $region->id }}" {{ selected($region->id, old('rsm_region_id')) }}>{{ $region->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <x-form-group>
                                        ...
                                        <input type="text" name="parent_sm_code" id="parent_sm_code" class="form-control" placeholder="Parent SM Code" value="{{ old('parent_sm_code') }}" />
                                ...
                                <div class="col-md-6">
                                    <x-form-group>
                                        ...
                                        <input type="text" name="buddy_name" id="buddy_name" class="form-control" placeholder="Buddy name" value="{{ old('buddy_name') }}" />
                                ...
                                <div class="col-md-6">
                                    <x-form-group>
                                        ...
                                        <input type="text" name="buddy_phone" id="buddy_phone" class="form-control" placeholder="Buddy phone" value="{{ old('buddy_phone') }}" />
...
@push('scripts')
    <script>
        $(document).ready(async function() {
            $("#tbl_depot_id,#rsm_region_id").select2();
        ...
        function reset_input_areas() {
            ...
            $('#tbl_depot_id, #user_code, #tbl_pso_user_type_id, #parent_rsm_code,#rsm_region_id').removeAttr('required');
        ...
        function show_rsm_area() {
            ...
            $('#rsm_region_id').attr('required', true);
