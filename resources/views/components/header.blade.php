                ...
                <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-35px"
                        ...
                        <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" data-bs-original-title="Perry Matthew" data-kt-initialized="1">
                            <span class="symbol-label bg-primary text-inverse-danger fw-bold">{{ strtoupper(auth()->user()->name[0]) }}</span>
                        </div>
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                        ...
                        {{-- <div class="menu-item px-5">
                            <a href="https://ismsplus.sslwireless.com" target="_blank" class="menu-link px-5">SMS Counter</a>
                        </div> --}}
                        <div class="separator my-2"></div>
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
